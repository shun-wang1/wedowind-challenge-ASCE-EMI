...
def main():
    ...
    base_path = r"../dataset"
    output_dir = r"../output_files_icing/"
    file_names = [
    ...
    fault_time = '2022-12-17 16:02:23'      # icing events
    ...
    #
    model_save_path = os.path.join(output_dir, "./trained_model_icing.pth")
    ...
    save_predictions_and_labels(predictions, true_labels, "predictions_and_labels_icing.csv", output_dir=output_dir)
